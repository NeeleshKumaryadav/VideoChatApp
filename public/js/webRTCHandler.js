...
const createPeerConnection = () =>{
    ...
    peerConection.onicecandidate = (event) =>{
        console.log("detting ice candidate  from stun server");
        if (event.candidate){
...
export const sendMesageUsingDataChannel = (message) =>{
...
export const handleWebRTCCandidate = async (data) =>{
    console.log("handling when trying to add received ice candidate");
    try{
...
export const switchBetweenCameraAndScreenSharing = async (screenSharingActive) =>{
    if (screenSharingActive) {
        ...
        try{
            ...
            //replace track with sender is sending
            const senders = peerConection.getSenders();
            ...
            console.log('error occured when trying to get screen sharing steam',err);
        }
    }
};
