...
//register event listener from personal code copy button
...
//register event for allow connection from strnager
...
newMessageInput.addEventListener('keydown', (event) =>{
    ...
    if (key ==='Enter'){
        webRTCHandler.sendMesageUsingDataChannel(event.target.value);
...
sendMessageButton.addEventListener('click',()=>{
    ...
    webRTCHandler.sendMesageUsingDataChannel(message);
